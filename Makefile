...
# Use standard library path flags instead of mixing raw paths into EE_LIBS directly
EE_LIBS = -L$(PS2SDK)/ports/lib -Llibs -lmc -lpad -lmtap -lpatches -lz -llzma -lzip -lfileXio -lelf-loader-nocolour -lerl -ldebug -lwolf4sdl -lSDL2main -lSDL2_mixer -lmodplug -lxmp -lSDL2 -laudsrv -latomic

EE_INCS += -I$(PS2SDK)/ports/include -I$(PS2SDK)/ports/include/zlib -Isrc/readini/include -Isrc/include -Isrc/include/wolf4sdl

EXT_LIBS += libs/libwolf4sdl.a
