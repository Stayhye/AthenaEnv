...
EXT_LIBS += libs/libwolf4sdl.a[cite: 1]
...
all: $(DIR_GUARD) $(EXT_LIBS) $(EE_OBJS)[cite: 1]
 ...
 # vu1_mpgs: src/vu1/draw_2D_tile_list.vsm src/vu1/draw_3D_colors.vsm src/vu1/draw_3D_lights.vsm src/vu1/draw_3D_spec.vsm src/vu1/draw_3D_colors_skin.vsm src/vu1/draw_3D_lights_skin.vsm src/vu1/draw_3D_spec_skin.vsm src/vu1/draw_3D_lights_ref.vsm [cite: 1]
 # vu0_mpgs: src/vu0/matrix_multiply.vsm[cite: 1]
...
# Build vendored BearSSL static library when present and TLS enabled[cite: 1]
